...
cd ../../c-code
echo "cmake -DCMAKE_BUILD_TYPE=Release -DBENCHMARKING=CYCLES -DARCHITECTURE=x8664 -B cmake-build-release-cycles-x8664-graph"
cmake -DCMAKE_BUILD_TYPE=Release -DBENCHMARKING=CYCLES -DARCHITECTURE=x8664 -B cmake-build-release-cycles-x8664-graph
echo "cd cmake-build-release-cycles-x8664-graph"
cd cmake-build-release-cycles-x8664-graph
echo "make -j"
make -j
