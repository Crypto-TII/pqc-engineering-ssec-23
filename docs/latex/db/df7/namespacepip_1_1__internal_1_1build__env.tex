...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1build__env_a20fa17bc521a3460d92508d07c7908fd} 
 Union\mbox{[}Tuple\mbox{[}str\mbox{]}, Tuple\mbox{[}str, str\mbox{]}\mbox{]} \+\_\+dedup (\begin{DoxyParamCaption}\item[{str}]{a}{, }\item[{str}]{b}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1build__env_a73239df605b6493cc43b1e3fe5ad6cc5} 
 Set\mbox{[}str\mbox{]} \+\_\+get\+\_\+system\+\_\+sitepackages (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
\DoxyCodeLine{00069\ \ \ \ \ \textcolor{keywordflow}{if}\ hasattr(site,\ \textcolor{stringliteral}{"{}getsitepackages"{}}):}
\DoxyCodeLine{00070\ \ \ \ \ \ \ \ \ system\_sites\ =\ site.getsitepackages()}
...
\DoxyCodeLine{00077\ \ \ \ \ \textcolor{keywordflow}{return}\ \{os.path.normcase(path)\ \textcolor{keywordflow}{for}\ path\ \textcolor{keywordflow}{in}\ system\_sites\}}
\DoxyCodeLine{00078\ }
\DoxyCodeLine{00079\ }
...
\DoxyCodeLine{00050\ \ \ \ \ source\ =\ pathlib.Path(pip\_location).resolve().parent}
\DoxyCodeLine{00051\ }
\DoxyCodeLine{00052\ \ \ \ \ \textcolor{keywordflow}{if}\ \textcolor{keywordflow}{not}\ source.is\_dir():}
...
\DoxyCodeLine{00056\ }
\DoxyCodeLine{00057\ \ \ \ \ \textcolor{keywordflow}{return}\ os.fsdecode(source\ /\ \textcolor{stringliteral}{"{}\_\_pip-\/runner\_\_.py"{}})}
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00059\ }
...
\Hypertarget{namespacepip_1_1__internal_1_1build__env_a0b14e488ae28d98d262453f3e9cd6e4d}\index{pip.\_internal.build\_env@{pip.\_internal.build\_env}!logger@{logger}}
\index{logger@{logger}!pip.\_internal.build\_env@{pip.\_internal.build\_env}}
\doxysubsubsection{\texorpdfstring{logger}{logger}}
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1build__env_a0b14e488ae28d98d262453f3e9cd6e4d} 
