...
\DoxyCodeLine{00036\ \ \ \ \ parts\ =\ dn.split(\textcolor{stringliteral}{r"{}."{}})}
\DoxyCodeLine{00037\ \ \ \ \ leftmost\ =\ parts[0]}
\DoxyCodeLine{00038\ \ \ \ \ remainder\ =\ parts[1:]}
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \ \ \ \ wildcards\ =\ leftmost.count(\textcolor{stringliteral}{"{}*"{}})}
...
\DoxyCodeLine{00052\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ dn.lower()\ ==\ hostname.lower()}
\DoxyCodeLine{00053\ }
...
\DoxyCodeLine{00060\ \ \ \ \ \ \ \ \ pats.append(\textcolor{stringliteral}{"{}[\string^.]+"{}})}
\DoxyCodeLine{00061\ \ \ \ \ \textcolor{keywordflow}{elif}\ leftmost.startswith(\textcolor{stringliteral}{"{}xn-\/-\/"{}})\ \textcolor{keywordflow}{or}\ hostname.startswith(\textcolor{stringliteral}{"{}xn-\/-\/"{}}):}
...
\DoxyCodeLine{00066\ \ \ \ \ \ \ \ \ pats.append(re.escape(leftmost))}
...
\DoxyCodeLine{00069\ \ \ \ \ \ \ \ \ pats.append(re.escape(leftmost).replace(\textcolor{stringliteral}{r"{}\(\backslash\)*"{}},\ \textcolor{stringliteral}{"{}[\string^.]*"{}}))}
\DoxyCodeLine{00070\ }
...
\DoxyCodeLine{00073\ \ \ \ \ \ \ \ \ pats.append(re.escape(frag))}
\DoxyCodeLine{00074\ }
\DoxyCodeLine{00075\ \ \ \ \ pat\ =\ re.compile(\textcolor{stringliteral}{r"{}\(\backslash\)A"{}}\ +\ \textcolor{stringliteral}{r"{}\(\backslash\)."{}}.join(pats)\ +\ \textcolor{stringliteral}{r"{}\(\backslash\)Z"{}},\ re.IGNORECASE)}
\DoxyCodeLine{00076\ \ \ \ \ \textcolor{keywordflow}{return}\ pat.match(hostname)}
\DoxyCodeLine{00077\ }
\DoxyCodeLine{00078\ }
...
\DoxyCodeLine{00094\ \ \ \ \ ip\ =\ ipaddress.ip\_address(\_to\_unicode(ipname).rstrip())}
...
References \mbox{\hyperlink{ssl__match__hostname_8py_source_l00079}{\+\_\+to\+\_\+unicode()}}.
...
\DoxyCodeLine{00080\ \ \ \ \ \textcolor{keywordflow}{if}\ isinstance(obj,\ str)\ \textcolor{keywordflow}{and}\ sys.version\_info\ <\ (3,):}
...
Referenced by \mbox{\hyperlink{ssl__match__hostname_8py_source_l00086}{\+\_\+ipaddress\+\_\+match()}}, and \mbox{\hyperlink{ssl__match__hostname_8py_source_l00098}{match\+\_\+hostname()}}.
...
\DoxyCodeLine{00114\ \ \ \ \ \ \ \ \ host\_ip\ =\ ipaddress.ip\_address(\_to\_unicode(hostname))}
...
\DoxyCodeLine{00128\ \ \ \ \ san\ =\ cert.get(\textcolor{stringliteral}{"{}subjectAltName"{}},\ ())}
...
\DoxyCodeLine{00133\ \ \ \ \ \ \ \ \ \ \ \ \ dnsnames.append(value)}
...
\DoxyCodeLine{00137\ \ \ \ \ \ \ \ \ \ \ \ \ dnsnames.append(value)}
...
\DoxyCodeLine{00141\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ sub\ \textcolor{keywordflow}{in}\ cert.get(\textcolor{stringliteral}{"{}subject"{}},\ ()):}
...
\DoxyCodeLine{00148\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ dnsnames.append(value)}
\DoxyCodeLine{00149\ \ \ \ \ \textcolor{keywordflow}{if}\ len(dnsnames)\ >\ 1:}
...
\DoxyCodeLine{00153\ \ \ \ \ \ \ \ \ )}
\DoxyCodeLine{00154\ \ \ \ \ \textcolor{keywordflow}{elif}\ len(dnsnames)\ ==\ 1:}
...
References \mbox{\hyperlink{ssl__match__hostname_8py_source_l00025}{\+\_\+dnsname\+\_\+match()}}, \mbox{\hyperlink{ssl__match__hostname_8py_source_l00086}{\+\_\+ipaddress\+\_\+match()}}, and \mbox{\hyperlink{ssl__match__hostname_8py_source_l00079}{\+\_\+to\+\_\+unicode()}}.
...
\Hypertarget{namespacepip_1_1__vendor_1_1urllib3_1_1util_1_1ssl__match__hostname_a306ffb6d4de33c930da7e13bb68823d0}\index{pip.\_vendor.urllib3.util.ssl\_match\_hostname@{pip.\_vendor.urllib3.util.ssl\_match\_hostname}!ipaddress@{ipaddress}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__vendor_1_1urllib3_1_1util_1_1ssl__match__hostname_a306ffb6d4de33c930da7e13bb68823d0} 
ipaddress = None}
