...
\DoxyCodeLine{00099\ \ \ \ \ \textcolor{keywordflow}{for}\ \_\ \textcolor{keywordflow}{in}\ range(10):}
\DoxyCodeLine{00100\ \ \ \ \ \ \ \ \ name\ =\ basename\ +\ \textcolor{stringliteral}{"{}"{}}.join(random.choice(alphabet)\ \textcolor{keywordflow}{for}\ \_\ \textcolor{keywordflow}{in}\ range(6))}
\DoxyCodeLine{00101\ \ \ \ \ \ \ \ \ file\ =\ os.path.join(path,\ name)}
\DoxyCodeLine{00102\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{try}:}
\DoxyCodeLine{00103\ \ \ \ \ \ \ \ \ \ \ \ \ fd\ =\ os.open(file,\ os.O\_RDWR\ |\ os.O\_CREAT\ |\ os.O\_EXCL)}
...
\DoxyCodeLine{00114\ \ \ \ \ \ \ \ \ \ \ \ \ os.close(fd)}
\DoxyCodeLine{00115\ \ \ \ \ \ \ \ \ \ \ \ \ os.unlink(file)}
...
\DoxyCodeLine{00119\ \ \ \ \ \textcolor{keywordflow}{raise}\ OSError(\textcolor{stringliteral}{"{}Unexpected\ condition\ testing\ for\ writable\ directory"{}})}
\DoxyCodeLine{00120\ }
\DoxyCodeLine{00121\ }
...
Referenced by \mbox{\hyperlink{filesystem_8py_source_l00076}{test\+\_\+writable\+\_\+dir()}}.
...
\begin{center}
\leavevmode
\includegraphics[width=316pt]{d5/d03/namespacepip_1_1__internal_1_1utils_1_1filesystem_afdd707f0b39b3448f9e5adb9034782e5_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1utils_1_1filesystem_a6f31acb411ea90a8226876d9235d66e5} 
 Generator\mbox{[}Binary\+IO, None, None\mbox{]} adjacent\+\_\+tmp\+\_\+file (\begin{DoxyParamCaption}\item[{str}]{path}{, }\item[{\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}Any}]{kwargs}{}\end{DoxyParamCaption})}
...
\DoxyCodeLine{00055\ \ \ \ \ \ \ \ \ dir=os.path.dirname(path),}
\DoxyCodeLine{00056\ \ \ \ \ \ \ \ \ prefix=os.path.basename(path),}
...
\DoxyCodeLine{00064\ \ \ \ \ \ \ \ \ \ \ \ \ result.flush()}
\DoxyCodeLine{00065\ \ \ \ \ \ \ \ \ \ \ \ \ os.fsync(result.fileno())}
\DoxyCodeLine{00066\ }
\DoxyCodeLine{00067\ }
...
\DoxyCodeLine{00019\ \ \ \ \ \textcolor{keywordflow}{if}\ sys.platform\ ==\ \textcolor{stringliteral}{"{}win32"{}}\ \textcolor{keywordflow}{or}\ \textcolor{keywordflow}{not}\ hasattr(os,\ \textcolor{stringliteral}{"{}geteuid"{}}):}
\DoxyCodeLine{00020\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{True}}
\DoxyCodeLine{00021\ }
\DoxyCodeLine{00022\ \ \ \ \ \textcolor{keyword}{assert}\ os.path.isabs(path)}
\DoxyCodeLine{00023\ }
\DoxyCodeLine{00024\ \ \ \ \ previous\ =\ \textcolor{keywordtype}{None}}
\DoxyCodeLine{00025\ \ \ \ \ \textcolor{keywordflow}{while}\ path\ !=\ previous:}
\DoxyCodeLine{00026\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ os.path.lexists(path):}
\DoxyCodeLine{00027\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{\#\ Check\ if\ path\ is\ writable\ by\ current\ user.}}
\DoxyCodeLine{00028\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ os.geteuid()\ ==\ 0:}
...
\DoxyCodeLine{00037\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ os.access(path,\ os.W\_OK)}
\DoxyCodeLine{00038\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}:}
\DoxyCodeLine{00039\ \ \ \ \ \ \ \ \ \ \ \ \ previous,\ path\ =\ path,\ os.path.dirname(path)}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1utils_1_1filesystem_a26de449fb6bd624b0de544fecbb2cc1e} 
 Union\mbox{[}int, float\mbox{]} directory\+\_\+size (\begin{DoxyParamCaption}\item[{str}]{path}{}\end{DoxyParamCaption})}
...
\DoxyCodeLine{00145\ \ \ \ \ \textcolor{keywordflow}{for}\ root,\ \_dirs,\ files\ \textcolor{keywordflow}{in}\ os.walk(path):}
\DoxyCodeLine{00146\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ filename\ \textcolor{keywordflow}{in}\ files:}
\DoxyCodeLine{00147\ \ \ \ \ \ \ \ \ \ \ \ \ file\_path\ =\ os.path.join(root,\ filename)}
...
References \mbox{\hyperlink{filesystem_8py_source_l00132}{file\+\_\+size()}}.



Referenced by \mbox{\hyperlink{filesystem_8py_source_l00152}{format\+\_\+directory\+\_\+size()}}.
...
\begin{center}
\leavevmode
\includegraphics[width=245pt]{d5/d03/namespacepip_1_1__internal_1_1utils_1_1filesystem_a26de449fb6bd624b0de544fecbb2cc1e_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=303pt]{d5/d03/namespacepip_1_1__internal_1_1utils_1_1filesystem_a26de449fb6bd624b0de544fecbb2cc1e_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1utils_1_1filesystem_a2aa934ca9a05385ea54ecf88bc2cab49} 
 Union\mbox{[}int, float\mbox{]} file\+\_\+size (\begin{DoxyParamCaption}\item[{str}]{path}{}\end{DoxyParamCaption})}
...
\DoxyCodeLine{00134\ \ \ \ \ \textcolor{keywordflow}{if}\ os.path.islink(path):}
\DoxyCodeLine{00135\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ 0}
\DoxyCodeLine{00136\ \ \ \ \ \textcolor{keywordflow}{return}\ os.path.getsize(path)}
\DoxyCodeLine{00137\ }
\DoxyCodeLine{00138\ }
...
Referenced by \mbox{\hyperlink{filesystem_8py_source_l00143}{directory\+\_\+size()}}, and \mbox{\hyperlink{filesystem_8py_source_l00139}{format\+\_\+file\+\_\+size()}}.
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1utils_1_1filesystem_a125b4f16b6ed72320da26bfe0d3a2f92} 
 List\mbox{[}str\mbox{]} find\+\_\+files (\begin{DoxyParamCaption}\item[{str}]{path}{, }\item[{str}]{pattern}{}\end{DoxyParamCaption})}
...
\DoxyCodeLine{00126\ \ \ \ \ \textcolor{keywordflow}{for}\ root,\ \_,\ files\ \textcolor{keywordflow}{in}\ os.walk(path):}
\DoxyCodeLine{00127\ \ \ \ \ \ \ \ \ matches\ =\ fnmatch.filter(files,\ pattern)}
\DoxyCodeLine{00128\ \ \ \ \ \ \ \ \ result.extend(os.path.join(root,\ f)\ \textcolor{keywordflow}{for}\ f\ \textcolor{keywordflow}{in}\ matches)}
...
References \mbox{\hyperlink{filesystem_8py_source_l00143}{directory\+\_\+size()}}.
...
\begin{center}
\leavevmode
\includegraphics[width=253pt]{d5/d03/namespacepip_1_1__internal_1_1utils_1_1filesystem_a48d710708470244b9ffd9c47cd65e142_cgraph}
\end{center}
\end{figure}
...
\DoxyCodeLine{00082\ \ \ \ \ \textcolor{keywordflow}{while}\ \textcolor{keywordflow}{not}\ os.path.isdir(path):}
\DoxyCodeLine{00083\ \ \ \ \ \ \ \ \ parent\ =\ os.path.dirname(path)}
...
\DoxyCodeLine{00087\ }
\DoxyCodeLine{00088\ \ \ \ \ \textcolor{keywordflow}{if}\ os.name\ ==\ \textcolor{stringliteral}{"{}posix"{}}:}
\DoxyCodeLine{00089\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ os.access(path,\ os.W\_OK)}
\DoxyCodeLine{00090\ }
...
References \mbox{\hyperlink{filesystem_8py_source_l00094}{\+\_\+test\+\_\+writable\+\_\+dir\+\_\+win()}}.
...
\begin{center}
\leavevmode
\includegraphics[width=316pt]{d5/d03/namespacepip_1_1__internal_1_1utils_1_1filesystem_aca8bcb76306c168b2728b7ef02cbff0e_cgraph}
\end{center}
\end{figure}
...
\Hypertarget{namespacepip_1_1__internal_1_1utils_1_1filesystem_a0692756d9628a37c2f52933a5dc73eef}\index{pip.\_internal.utils.filesystem@{pip.\_internal.utils.filesystem}!\_replace\_retry@{\_replace\_retry}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1utils_1_1filesystem_a0692756d9628a37c2f52933a5dc73eef} 
\+\_\+replace\+\_\+retry = retry(reraise=True, stop=\mbox{\hyperlink{classpip_1_1__vendor_1_1tenacity_1_1stop_1_1stop__after__delay}{stop\+\_\+after\+\_\+delay}}(1), wait=\mbox{\hyperlink{classpip_1_1__vendor_1_1tenacity_1_1wait_1_1wait__fixed}{wait\+\_\+fixed}}(0.\+25))\hspace{0.3cm}{\ttfamily [protected]}}
...
\Hypertarget{namespacepip_1_1__internal_1_1utils_1_1filesystem_a42385a0b3c596879a9b70b0df184bb7a}\index{pip.\_internal.utils.filesystem@{pip.\_internal.utils.filesystem}!replace@{replace}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1utils_1_1filesystem_a42385a0b3c596879a9b70b0df184bb7a} 
replace = \mbox{\hyperlink{namespacepip_1_1__internal_1_1utils_1_1filesystem_a0692756d9628a37c2f52933a5dc73eef}{\+\_\+replace\+\_\+retry}}(os.\+replace)}
