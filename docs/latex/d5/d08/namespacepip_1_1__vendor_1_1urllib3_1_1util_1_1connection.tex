...
\DoxyCodeLine{00128\ \ \ \ \ \textcolor{keywordflow}{if}\ \_appengine\_environ.is\_appengine\_sandbox():}
\DoxyCodeLine{00129\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{False}}
\DoxyCodeLine{00130\ }
\DoxyCodeLine{00131\ \ \ \ \ \textcolor{keywordflow}{if}\ socket.has\_ipv6:}
...
\DoxyCodeLine{00138\ \ \ \ \ \ \ \ \ \ \ \ \ sock\ =\ socket.socket(socket.AF\_INET6)}
\DoxyCodeLine{00139\ \ \ \ \ \ \ \ \ \ \ \ \ sock.bind((host,\ 0))}
...
\DoxyCodeLine{00105\ \ \ \ \ \ \ \ \ sock.setsockopt(*opt)}
\DoxyCodeLine{00106\ }
\DoxyCodeLine{00107\ }
...
\DoxyCodeLine{00112\ }
\DoxyCodeLine{00113\ \ \ \ \ family\ =\ socket.AF\_INET}
\DoxyCodeLine{00114\ \ \ \ \ \textcolor{keywordflow}{if}\ HAS\_IPV6:}
\DoxyCodeLine{00115\ \ \ \ \ \ \ \ \ family\ =\ socket.AF\_UNSPEC}
...
\DoxyCodeLine{00056\ \ \ \ \ \textcolor{keywordflow}{if}\ host.startswith(\textcolor{stringliteral}{"{}["{}}):}
\DoxyCodeLine{00057\ \ \ \ \ \ \ \ \ host\ =\ host.strip(\textcolor{stringliteral}{"{}[]"{}})}
...
\DoxyCodeLine{00066\ \ \ \ \ \ \ \ \ host.encode(\textcolor{stringliteral}{"{}idna"{}})}
\DoxyCodeLine{00067\ \ \ \ \ \textcolor{keywordflow}{except}\ UnicodeError:}
\DoxyCodeLine{00068\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ six.raise\_from(}
\DoxyCodeLine{00069\ \ \ \ \ \ \ \ \ \ \ \ \ LocationParseError(\textcolor{stringliteral}{u"{}'\%s',\ label\ empty\ or\ too\ long"{}}\ \%\ host),\ \textcolor{keywordtype}{None}}
\DoxyCodeLine{00070\ \ \ \ \ \ \ \ \ )}
\DoxyCodeLine{00071\ }
\DoxyCodeLine{00072\ \ \ \ \ \textcolor{keywordflow}{for}\ res\ \textcolor{keywordflow}{in}\ socket.getaddrinfo(host,\ port,\ family,\ socket.SOCK\_STREAM):}
...
\DoxyCodeLine{00076\ \ \ \ \ \ \ \ \ \ \ \ \ sock\ =\ socket.socket(af,\ socktype,\ proto)}
\DoxyCodeLine{00077\ }
...
\DoxyCodeLine{00080\ }
\DoxyCodeLine{00081\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ timeout\ \textcolor{keywordflow}{is}\ \textcolor{keywordflow}{not}\ socket.\_GLOBAL\_DEFAULT\_TIMEOUT:}
\DoxyCodeLine{00082\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ sock.settimeout(timeout)}
\DoxyCodeLine{00083\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ source\_address:}
\DoxyCodeLine{00084\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ sock.bind(source\_address)}
\DoxyCodeLine{00085\ \ \ \ \ \ \ \ \ \ \ \ \ sock.connect(sa)}
\DoxyCodeLine{00086\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ sock}
\DoxyCodeLine{00087\ }
\DoxyCodeLine{00088\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{except}\ socket.error\ \textcolor{keyword}{as}\ e:}
...
\DoxyCodeLine{00096\ }
\DoxyCodeLine{00097\ \ \ \ \ \textcolor{keywordflow}{raise}\ socket.error(\textcolor{stringliteral}{"{}getaddrinfo\ returns\ an\ empty\ list"{}})}
\DoxyCodeLine{00098\ }
\DoxyCodeLine{00099\ }
...
References \mbox{\hyperlink{util_2connection_8py_source_l00100}{\+\_\+set\+\_\+socket\+\_\+options()}}, and \mbox{\hyperlink{util_2connection_8py_source_l00108}{allowed\+\_\+gai\+\_\+family()}}.
...
\DoxyCodeLine{00021\ \ \ \ \ sock\ =\ getattr(conn,\ \textcolor{stringliteral}{"{}sock"{}},\ \textcolor{keyword}{False})}
...
\Hypertarget{namespacepip_1_1__vendor_1_1urllib3_1_1util_1_1connection_af6d7aec4e9cd41bfcbd8d04ce27ba9ae}\index{pip.\_vendor.urllib3.util.connection@{pip.\_vendor.urllib3.util.connection}!HAS\_IPV6@{HAS\_IPV6}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__vendor_1_1urllib3_1_1util_1_1connection_af6d7aec4e9cd41bfcbd8d04ce27ba9ae} 
HAS\+\_\+\+IPV6 = \mbox{\hyperlink{namespacepip_1_1__vendor_1_1urllib3_1_1util_1_1connection_a595b0ed93e62ea9e136253639a73d841}{\+\_\+has\+\_\+ipv6}}("{}\+::1"{})}
