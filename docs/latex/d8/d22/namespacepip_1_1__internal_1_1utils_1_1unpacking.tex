...
\DoxyCodeLine{00045\ \ \ \ \ mask\ =\ os.umask(0)}
\DoxyCodeLine{00046\ \ \ \ \ os.umask(mask)}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d8/d22/namespacepip_1_1__internal_1_1utils_1_1unpacking_af0f6c2a138b90a3f8509e104e711247a_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1utils_1_1unpacking_a37780b46b0d1d9317c8eccf175225dc5} 
 bool has\+\_\+leading\+\_\+dir (\begin{DoxyParamCaption}\item[{Iterable\mbox{[}str\mbox{]}}]{paths}{}\end{DoxyParamCaption})}
...
References \mbox{\hyperlink{unpacking_8py_source_l00050}{split\+\_\+leading\+\_\+dir()}}.
...
\DoxyCodeLine{00081\ \ \ \ \ abs\_directory\ =\ os.path.abspath(directory)}
\DoxyCodeLine{00082\ \ \ \ \ abs\_target\ =\ os.path.abspath(target)}
\DoxyCodeLine{00083\ }
\DoxyCodeLine{00084\ \ \ \ \ prefix\ =\ os.path.commonprefix([abs\_directory,\ abs\_target])}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d8/d22/namespacepip_1_1__internal_1_1utils_1_1unpacking_a35e36944c8599945de0120df6ebfb1b6_icgraph}
\end{center}
\end{figure}
...
\DoxyCodeLine{00093\ \ \ \ \ os.chmod(path,\ (0o777\ \&\ \string~current\_umask()\ |\ 0o111))}
\DoxyCodeLine{00094\ }
\DoxyCodeLine{00095\ }
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d8/d22/namespacepip_1_1__internal_1_1utils_1_1unpacking_a45246969f08c73a1507a2ffaee1178fd_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1utils_1_1unpacking_a00692ba5e206beb08b428fba04480597} 
 List\mbox{[}str\mbox{]} split\+\_\+leading\+\_\+dir (\begin{DoxyParamCaption}\item[{str}]{path}{}\end{DoxyParamCaption})}
...
\DoxyCodeLine{00051\ \ \ \ \ path\ =\ path.lstrip(\textcolor{stringliteral}{"{}/"{}}).lstrip(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)"{}})}
...
\DoxyCodeLine{00054\ \ \ \ \ ):}
\DoxyCodeLine{00055\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ path.split(\textcolor{stringliteral}{"{}/"{}},\ 1)}
\DoxyCodeLine{00056\ \ \ \ \ \textcolor{keywordflow}{elif}\ \textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)"{}}\ \textcolor{keywordflow}{in}\ path:}
\DoxyCodeLine{00057\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ path.split(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)"{}},\ 1)}
...
Referenced by \mbox{\hyperlink{unpacking_8py_source_l00062}{has\+\_\+leading\+\_\+dir()}}, \mbox{\hyperlink{unpacking_8py_source_l00149}{untar\+\_\+file()}}, and \mbox{\hyperlink{unpacking_8py_source_l00103}{unzip\+\_\+file()}}.
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1utils_1_1unpacking_a2e4ec14ef37f131edfc2e29f087047e7} 
 None unpack\+\_\+file (\begin{DoxyParamCaption}\item[{str}]{filename}{, }\item[{str}]{location}{, }\item[{Optional\mbox{[}str\mbox{]} }]{content\+\_\+type}{ = {\ttfamily None}}\end{DoxyParamCaption})}
...
\DoxyCodeLine{00234\ \ \ \ \ filename\ =\ os.path.realpath(filename)}
\DoxyCodeLine{00235\ \ \ \ \ \textcolor{keywordflow}{if}\ (}
\DoxyCodeLine{00236\ \ \ \ \ \ \ \ \ content\_type\ ==\ \textcolor{stringliteral}{"{}application/zip"{}}}
\DoxyCodeLine{00237\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{or}\ filename.lower().endswith(ZIP\_EXTENSIONS)}
\DoxyCodeLine{00238\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{or}\ zipfile.is\_zipfile(filename)}
\DoxyCodeLine{00239\ \ \ \ \ ):}
\DoxyCodeLine{00240\ \ \ \ \ \ \ \ \ unzip\_file(filename,\ location,\ flatten=\textcolor{keywordflow}{not}\ filename.endswith(\textcolor{stringliteral}{"{}.whl"{}}))}
\DoxyCodeLine{00241\ \ \ \ \ \textcolor{keywordflow}{elif}\ (}
\DoxyCodeLine{00242\ \ \ \ \ \ \ \ \ content\_type\ ==\ \textcolor{stringliteral}{"{}application/x-\/gzip"{}}}
\DoxyCodeLine{00243\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{or}\ tarfile.is\_tarfile(filename)}
\DoxyCodeLine{00244\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{or}\ filename.lower().endswith(TAR\_EXTENSIONS\ +\ BZ2\_EXTENSIONS\ +\ XZ\_EXTENSIONS)}
\DoxyCodeLine{00245\ \ \ \ \ ):}
...
\DoxyCodeLine{00250\ \ \ \ \ \ \ \ \ logger.critical(}
...
References \mbox{\hyperlink{unpacking_8py_source_l00149}{untar\+\_\+file()}}, and \mbox{\hyperlink{unpacking_8py_source_l00103}{unzip\+\_\+file()}}.
...
\DoxyCodeLine{00159\ \ \ \ \ \textcolor{keywordflow}{if}\ filename.lower().endswith(\textcolor{stringliteral}{"{}.gz"{}})\ \textcolor{keywordflow}{or}\ filename.lower().endswith(\textcolor{stringliteral}{"{}.tgz"{}}):}
\DoxyCodeLine{00160\ \ \ \ \ \ \ \ \ mode\ =\ \textcolor{stringliteral}{"{}r:gz"{}}}
\DoxyCodeLine{00161\ \ \ \ \ \textcolor{keywordflow}{elif}\ filename.lower().endswith(BZ2\_EXTENSIONS):}
\DoxyCodeLine{00162\ \ \ \ \ \ \ \ \ mode\ =\ \textcolor{stringliteral}{"{}r:bz2"{}}}
\DoxyCodeLine{00163\ \ \ \ \ \textcolor{keywordflow}{elif}\ filename.lower().endswith(XZ\_EXTENSIONS):}
\DoxyCodeLine{00164\ \ \ \ \ \ \ \ \ mode\ =\ \textcolor{stringliteral}{"{}r:xz"{}}}
\DoxyCodeLine{00165\ \ \ \ \ \textcolor{keywordflow}{elif}\ filename.lower().endswith(\textcolor{stringliteral}{"{}.tar"{}}):}
\DoxyCodeLine{00166\ \ \ \ \ \ \ \ \ mode\ =\ \textcolor{stringliteral}{"{}r"{}}}
\DoxyCodeLine{00167\ \ \ \ \ \textcolor{keywordflow}{else}:}
\DoxyCodeLine{00168\ \ \ \ \ \ \ \ \ logger.warning(}
...
\DoxyCodeLine{00173\ \ \ \ \ tar\ =\ tarfile.open(filename,\ mode,\ encoding=\textcolor{stringliteral}{"{}utf-\/8"{}})}
\DoxyCodeLine{00174\ \ \ \ \ \textcolor{keywordflow}{try}:}
\DoxyCodeLine{00175\ \ \ \ \ \ \ \ \ leading\ =\ has\_leading\_dir([member.name\ \textcolor{keywordflow}{for}\ member\ \textcolor{keywordflow}{in}\ tar.getmembers()])}
\DoxyCodeLine{00176\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ member\ \textcolor{keywordflow}{in}\ tar.getmembers():}
\DoxyCodeLine{00177\ \ \ \ \ \ \ \ \ \ \ \ \ fn\ =\ member.name}
\DoxyCodeLine{00178\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ leading:}
\DoxyCodeLine{00179\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ fn\ =\ split\_leading\_dir(fn)[1]}
\DoxyCodeLine{00180\ \ \ \ \ \ \ \ \ \ \ \ \ path\ =\ os.path.join(location,\ fn)}
...
\DoxyCodeLine{00185\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ )}
\DoxyCodeLine{00186\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{raise}\ InstallationError(message.format(filename,\ path,\ location))}
\DoxyCodeLine{00187\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ member.isdir():}
\DoxyCodeLine{00188\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ensure\_dir(path)}
\DoxyCodeLine{00189\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{elif}\ member.issym():}
\DoxyCodeLine{00190\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{try}:}
\DoxyCodeLine{00191\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ tar.\_extract\_member(member,\ path)}
...
\DoxyCodeLine{00204\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ fp\ =\ tar.extractfile(member)}
...
References \mbox{\hyperlink{unpacking_8py_source_l00062}{has\+\_\+leading\+\_\+dir()}}, \mbox{\hyperlink{unpacking_8py_source_l00077}{is\+\_\+within\+\_\+directory()}}, \mbox{\hyperlink{unpacking_8py_source_l00088}{set\+\_\+extracted\+\_\+file\+\_\+to\+\_\+default\+\_\+mode\+\_\+plus\+\_\+executable()}}, and \mbox{\hyperlink{unpacking_8py_source_l00050}{split\+\_\+leading\+\_\+dir()}}.



Referenced by \mbox{\hyperlink{unpacking_8py_source_l00233}{unpack\+\_\+file()}}.
...
\DoxyCodeLine{00115\ \ \ \ \ \ \ \ \ zip\ =\ zipfile.ZipFile(zipfp,\ allowZip64=\textcolor{keyword}{True})}
\DoxyCodeLine{00116\ \ \ \ \ \ \ \ \ leading\ =\ has\_leading\_dir(zip.namelist())\ \textcolor{keywordflow}{and}\ flatten}
\DoxyCodeLine{00117\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ info\ \textcolor{keywordflow}{in}\ zip.infolist():}
\DoxyCodeLine{00118\ \ \ \ \ \ \ \ \ \ \ \ \ name\ =\ info.filename}
...
\DoxyCodeLine{00122\ \ \ \ \ \ \ \ \ \ \ \ \ fn\ =\ os.path.join(location,\ fn)}
\DoxyCodeLine{00123\ \ \ \ \ \ \ \ \ \ \ \ \ dir\ =\ os.path.dirname(fn)}
...
\DoxyCodeLine{00128\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ )}
\DoxyCodeLine{00129\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{raise}\ InstallationError(message.format(filename,\ fn,\ location))}
\DoxyCodeLine{00130\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ fn.endswith(\textcolor{stringliteral}{"{}/"{}})\ \textcolor{keywordflow}{or}\ fn.endswith(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)"{}}):}
...
\DoxyCodeLine{00137\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ fp\ =\ zip.open(name)}
...
\DoxyCodeLine{00140\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ shutil.copyfileobj(fp,\ destfp)}
\DoxyCodeLine{00141\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{finally}:}
\DoxyCodeLine{00142\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ fp.close()}
...
\DoxyCodeLine{00146\ \ \ \ \ \ \ \ \ zipfp.close()}
\DoxyCodeLine{00147\ }
\DoxyCodeLine{00148\ }
...
References \mbox{\hyperlink{unpacking_8py_source_l00062}{has\+\_\+leading\+\_\+dir()}}, \mbox{\hyperlink{unpacking_8py_source_l00077}{is\+\_\+within\+\_\+directory()}}, \mbox{\hyperlink{unpacking_8py_source_l00088}{set\+\_\+extracted\+\_\+file\+\_\+to\+\_\+default\+\_\+mode\+\_\+plus\+\_\+executable()}}, \mbox{\hyperlink{unpacking_8py_source_l00050}{split\+\_\+leading\+\_\+dir()}}, and \mbox{\hyperlink{unpacking_8py_source_l00096}{zip\+\_\+item\+\_\+is\+\_\+executable()}}.
...
\DoxyCodeLine{00097\ \ \ \ \ mode\ =\ info.external\_attr\ >>\ 16}
...
\DoxyCodeLine{00100\ \ \ \ \ \textcolor{keywordflow}{return}\ bool(mode\ \textcolor{keywordflow}{and}\ stat.S\_ISREG(mode)\ \textcolor{keywordflow}{and}\ mode\ \&\ 0o111)}
\DoxyCodeLine{00101\ }
\DoxyCodeLine{00102\ }
...
Referenced by \mbox{\hyperlink{unpacking_8py_source_l00103}{unzip\+\_\+file()}}.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d8/d22/namespacepip_1_1__internal_1_1utils_1_1unpacking_ae4f7ac75282bfddedfd46778640a939b_icgraph}
\end{center}
\end{figure}
...
\Hypertarget{namespacepip_1_1__internal_1_1utils_1_1unpacking_a0b14e488ae28d98d262453f3e9cd6e4d}\index{pip.\_internal.utils.unpacking@{pip.\_internal.utils.unpacking}!logger@{logger}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1utils_1_1unpacking_a0b14e488ae28d98d262453f3e9cd6e4d} 
...
\Hypertarget{namespacepip_1_1__internal_1_1utils_1_1unpacking_a2d49e2978a121bad364ce115163cc52a}\index{pip.\_internal.utils.unpacking@{pip.\_internal.utils.unpacking}!SUPPORTED\_EXTENSIONS@{SUPPORTED\_EXTENSIONS}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1utils_1_1unpacking_a2d49e2978a121bad364ce115163cc52a} 
SUPPORTED\+\_\+\+EXTENSIONS = ZIP\+\_\+\+EXTENSIONS + TAR\+\_\+\+EXTENSIONS}
