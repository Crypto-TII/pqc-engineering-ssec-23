...
\DoxyCodeLine{00055\ \ \ \ \ \textcolor{keywordflow}{if}\ \textcolor{keywordflow}{not}\ isinstance(headers,\ httplib.HTTPMessage):}
...
\DoxyCodeLine{00057\ }
\DoxyCodeLine{00058\ \ \ \ \ defects\ =\ getattr(headers,\ \textcolor{stringliteral}{"{}defects"{}},\ \textcolor{keywordtype}{None})}
\DoxyCodeLine{00059\ \ \ \ \ get\_payload\ =\ getattr(headers,\ \textcolor{stringliteral}{"{}get\_payload"{}},\ \textcolor{keywordtype}{None})}
\DoxyCodeLine{00060\ }
...
\DoxyCodeLine{00065\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ \textcolor{keywordflow}{not}\ headers.is\_multipart():}
\DoxyCodeLine{00066\ \ \ \ \ \ \ \ \ \ \ \ \ payload\ =\ get\_payload()}
\DoxyCodeLine{00067\ }
\DoxyCodeLine{00068\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ isinstance(payload,\ (bytes,\ str)):}
...
\DoxyCodeLine{00085\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ \textcolor{keywordflow}{not}\ isinstance(}
...
\DoxyCodeLine{00020\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ obj.isclosed()}
...
\DoxyCodeLine{00026\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ obj.closed}
...
\DoxyCodeLine{00033\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ obj.fp\ \textcolor{keywordflow}{is}\ \textcolor{keywordtype}{None}}
...
\DoxyCodeLine{00104\ \ \ \ \ method\ =\ response.\_method}
\DoxyCodeLine{00105\ \ \ \ \ \textcolor{keywordflow}{if}\ isinstance(method,\ int):\ \ \textcolor{comment}{\#\ Platform-\/specific:\ Appengine}}
\DoxyCodeLine{00106\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ method\ ==\ 3}
\DoxyCodeLine{00107\ \ \ \ \ \textcolor{keywordflow}{return}\ method.upper()\ ==\ \textcolor{stringliteral}{"{}HEAD"{}}}
