...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1package__finder_a5dbf97f0a3513a0d8fe848ce8b6778ee} 
 bool \+\_\+check\+\_\+link\+\_\+requires\+\_\+python (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classpip_1_1__internal_1_1models_1_1link_1_1_link}{Link}}}]{link}{, }\item[{Tuple\mbox{[}int, int, int\mbox{]}}]{version\+\_\+info}{, }\item[{bool }]{ignore\+\_\+requires\+\_\+python}{ = {\ttfamily False}}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
\DoxyCodeLine{00067\ \ \ \ \ \ \ \ \ \ \ \ \ link.requires\_python,}
\DoxyCodeLine{00068\ \ \ \ \ \ \ \ \ \ \ \ \ version\_info=version\_info,}
\DoxyCodeLine{00069\ \ \ \ \ \ \ \ \ )}
\DoxyCodeLine{00070\ \ \ \ \ \textcolor{keywordflow}{except}\ specifiers.InvalidSpecifier:}
\DoxyCodeLine{00071\ \ \ \ \ \ \ \ \ logger.debug(}
\DoxyCodeLine{00072\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}Ignoring\ invalid\ Requires-\/Python\ (\%r)\ for\ link:\ \%s"{}},}
\DoxyCodeLine{00073\ \ \ \ \ \ \ \ \ \ \ \ \ link.requires\_python,}
...
\DoxyCodeLine{00091\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ link.requires\_python,}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1package__finder_a067b01bc0ed2ad9d63d1828c991f258c} 
 Optional\mbox{[}str\mbox{]} \+\_\+extract\+\_\+version\+\_\+from\+\_\+fragment (\begin{DoxyParamCaption}\item[{str}]{fragment}{, }\item[{str}]{canonical\+\_\+name}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
References \mbox{\hyperlink{package__finder_8py_source_l00988}{\+\_\+find\+\_\+name\+\_\+version\+\_\+sep()}}.
...
\DoxyCodeLine{01006\ \ \ \ \ \textcolor{keywordflow}{for}\ i,\ c\ \textcolor{keywordflow}{in}\ enumerate(fragment):}
...
Referenced by \mbox{\hyperlink{package__finder_8py_source_l01014}{\+\_\+extract\+\_\+version\+\_\+from\+\_\+fragment()}}.
...
\DoxyCodeLine{00273\ \ \ \ \ \ \ \ \ logger.debug(}
...
\DoxyCodeLine{00276\ \ \ \ \ \ \ \ \ \ \ \ \ len(candidates),}
...
\DoxyCodeLine{00287\ \ \ \ \ \ \ \ \ link\ =\ candidate.link}
\DoxyCodeLine{00288\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ \textcolor{keywordflow}{not}\ link.has\_hash:}
\DoxyCodeLine{00289\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{pass}}
\DoxyCodeLine{00290\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{elif}\ link.is\_hash\_allowed(hashes=hashes):}
\DoxyCodeLine{00291\ \ \ \ \ \ \ \ \ \ \ \ \ match\_count\ +=\ 1}
\DoxyCodeLine{00292\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}:}
\DoxyCodeLine{00293\ \ \ \ \ \ \ \ \ \ \ \ \ non\_matches.append(candidate)}
\DoxyCodeLine{00294\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{continue}}
\DoxyCodeLine{00295\ }
\DoxyCodeLine{00296\ \ \ \ \ \ \ \ \ matches\_or\_no\_digest.append(candidate)}
\DoxyCodeLine{00297\ }
...
\DoxyCodeLine{00303\ }
\DoxyCodeLine{00304\ \ \ \ \ \textcolor{keywordflow}{if}\ len(filtered)\ ==\ len(candidates):}
...
\DoxyCodeLine{00308\ \ \ \ \ \ \ \ \ \ \ \ \ len(non\_matches),}
\DoxyCodeLine{00309\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}\(\backslash\)n\ \ "{}}.join(str(candidate.link)\ \textcolor{keywordflow}{for}\ candidate\ \textcolor{keywordflow}{in}\ non\_matches),}
\DoxyCodeLine{00310\ \ \ \ \ \ \ \ \ )}
\DoxyCodeLine{00311\ }
\DoxyCodeLine{00312\ \ \ \ \ logger.debug(}
...
\DoxyCodeLine{00315\ \ \ \ \ \ \ \ \ len(candidates),}
\DoxyCodeLine{00316\ \ \ \ \ \ \ \ \ project\_name,}
\DoxyCodeLine{00317\ \ \ \ \ \ \ \ \ hashes.digest\_count,}
\DoxyCodeLine{00318\ \ \ \ \ \ \ \ \ match\_count,}
\DoxyCodeLine{00319\ \ \ \ \ \ \ \ \ len(matches\_or\_no\_digest)\ -\/\ match\_count,}
...
\Hypertarget{namespacepip_1_1__internal_1_1index_1_1package__finder_ac65be78d07f053f2b25ad7e91080c042}\index{pip.\_internal.index.package\_finder@{pip.\_internal.index.package\_finder}!BuildTag@{BuildTag}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1package__finder_ac65be78d07f053f2b25ad7e91080c042} 
...
\Hypertarget{namespacepip_1_1__internal_1_1index_1_1package__finder_a4b1dbf3b87ef9da7bda5f86246f9fe62}\index{pip.\_internal.index.package\_finder@{pip.\_internal.index.package\_finder}!CandidateSortingKey@{CandidateSortingKey}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1package__finder_a4b1dbf3b87ef9da7bda5f86246f9fe62} 
Candidate\+Sorting\+Key = Tuple\mbox{[}int, int, int, \mbox{\hyperlink{classpip_1_1__vendor_1_1packaging_1_1version_1_1___base_version}{\+\_\+\+Base\+Version}}, Optional\mbox{[}int\mbox{]}, \mbox{\hyperlink{namespacepip_1_1__internal_1_1index_1_1package__finder_ac65be78d07f053f2b25ad7e91080c042}{Build\+Tag}}\mbox{]}}
...
\Hypertarget{namespacepip_1_1__internal_1_1index_1_1package__finder_a0b14e488ae28d98d262453f3e9cd6e4d}\index{pip.\_internal.index.package\_finder@{pip.\_internal.index.package\_finder}!logger@{logger}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1package__finder_a0b14e488ae28d98d262453f3e9cd6e4d} 
