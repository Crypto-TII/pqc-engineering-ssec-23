\doxysection{E\+:/pqc-\/engineering-\/ssec-\/23/c-\/code Directory Reference}
\hypertarget{dir_1f1f6de2e07c20a4acbe8146df0d4b37}{}\label{dir_1f1f6de2e07c20a4acbe8146df0d4b37}\index{E:/pqc-\/engineering-\/ssec-\/23/c-\/code Directory Reference@{E:/pqc-\/engineering-\/ssec-\/23/c-\/code Directory Reference}}
Directory dependency graph for c-\/code\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{dir_1f1f6de2e07c20a4acbe8146df0d4b37_dep}
\end{center}
\end{figure}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \mbox{\hyperlink{dir_eb43c8090f3f2e74df6fa114406fc284}{benchmarks}}
\item 
directory \mbox{\hyperlink{dir_9a4b3884d6588f92b15040e4fb522afb}{src}}
\item 
directory \mbox{\hyperlink{dir_9bba0858ae8190fe33109d7d291afcf0}{tests}}
\item 
directory \mbox{\hyperlink{dir_5cebbb6edf60af419d9e254da23079c8}{utils}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md0}{}\doxysubsection{\texorpdfstring{Let us walk on the 3-\/isogeny graph\+: (Detailed) Build, Test and Benchmarking Framework Documentation}{Let us walk on the 3-\/isogeny graph\+: (Detailed) Build, Test and Benchmarking Framework Documentation}}\label{README.md_autotoc_md0}
\hypertarget{README.md_autotoc_md1}{}\doxysubsection{\texorpdfstring{Table of contents}{Table of contents}}\label{README.md_autotoc_md1}
...
\item \doxylink{index_section_02_03}{Make test targets} ~\newline
...
\begin{DoxyEnumerate}
\item \doxylink{README.md_section_07_01}{Benchmarking CPU cycles and Execution Time}
\end{DoxyEnumerate}
\item \doxylink{README.md_section_08}{References}
\end{DoxyEnumerate}

\label{index_section_01}%
\Hypertarget{index_section_01}%
 \hypertarget{README.md_autotoc_md2}{}\doxysubsection{\texorpdfstring{1. Introduction}{1. Introduction}}\label{README.md_autotoc_md2}
...
\Hypertarget{index_section_02}%
 \hypertarget{README.md_autotoc_md3}{}\doxysubsection{\texorpdfstring{2. Build}{2. Build}}\label{README.md_autotoc_md3}
The following instructions work on both Linux and Mac\+OS using CMAKE. {\bfseries{NOTE\+: Only Intel x86\+\_\+64 is currently supported.}}

\label{index_section_02_01}%
\Hypertarget{index_section_02_01}%
 \hypertarget{README.md_autotoc_md4}{}\doxysubsubsection{\texorpdfstring{2.\+1. Cmake configuration}{2.\+1. Cmake configuration}}\label{README.md_autotoc_md4}
...
\Hypertarget{index_section_02_02}%
 \hypertarget{README.md_autotoc_md5}{}\doxysubsubsection{\texorpdfstring{2.\+2. Make library targets}{2.\+2. Make library targets}}\label{README.md_autotoc_md5}
...
\Hypertarget{index_section_02_03}%
 \hypertarget{README.md_autotoc_md6}{}\doxysubsubsection{\texorpdfstring{2.\+3. Make test targets}{2.\+3. Make test targets}}\label{README.md_autotoc_md6}
...
\Hypertarget{index_section_03}%
 \hypertarget{README.md_autotoc_md7}{}\doxysubsection{\texorpdfstring{3. Tests}{3. Tests}}\label{README.md_autotoc_md7}
...
\Hypertarget{index_section_04}%
 \hypertarget{README.md_autotoc_md8}{}\doxysubsection{\texorpdfstring{4. Benchmarking}{4. Benchmarking}}\label{README.md_autotoc_md8}
...
\Hypertarget{index_section_05}%
 \hypertarget{README.md_autotoc_md9}{}\doxysubsection{\texorpdfstring{5. Benchmarking script}{5. Benchmarking script}}\label{README.md_autotoc_md9}
...
\Hypertarget{index_section_06}%
 \hypertarget{README.md_autotoc_md10}{}\doxysubsection{\texorpdfstring{6. Remarks}{6. Remarks}}\label{README.md_autotoc_md10}
...
\Hypertarget{index_section_07}%
 \hypertarget{README.md_autotoc_md11}{}\doxysubsection{\texorpdfstring{7. Appendix\+: CPU benchmarking details}{7. Appendix\+: CPU benchmarking details}}\label{README.md_autotoc_md11}
...
\label{README.md_section_07_01}%
\Hypertarget{README.md_section_07_01}%
 \hypertarget{README.md_autotoc_md12}{}\doxysubsubsection{\texorpdfstring{7.\+1. Benchmarking CPU cycles and Execution Time}{7.\+1. Benchmarking CPU cycles and Execution Time}}\label{README.md_autotoc_md12}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ timespec\_get(\textcolor{keyword}{struct}\ timespec\ *ts,\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{ctidh_8h_a6542a2bd356f5c5a12e03135a66e2dae}{base}});}
...
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \textcolor{keyword}{struct\ }timespec\ ts;}
\DoxyCodeLine{\ \ \ timespec\_get(\&ts,\ TIME\_UTC);}
\DoxyCodeLine{\ \ \ \textcolor{keywordflow}{return}\ (\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}\ \textcolor{keywordtype}{long})ts.tv\_sec\ *\ \(\backslash\)textcolor\{blue\}\{1000000000ull\}\ +\ ts.tv\_nsec;}
\DoxyCodeLine{\}}

\end{DoxyCode}
 \label{README.md_section_08}%
\Hypertarget{README.md_section_08}%
 \hypertarget{README.md_autotoc_md13}{}\doxysubsection{\texorpdfstring{8. References}{8. References}}\label{README.md_autotoc_md13}
