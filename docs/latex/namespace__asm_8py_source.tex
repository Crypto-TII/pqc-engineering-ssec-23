...
\hypertarget{namespace__asm_8py_source}{}\label{namespace__asm_8py_source}\index{C:/Users/liwuen/Desktop/Doxygen local test/pqc-\/engineering-\/ssec-\/23/dCTIDH/src/common/fp/namespace\_asm.py@{C:/Users/liwuen/Desktop/Doxygen local test/pqc-\/engineering-\/ssec-\/23/dCTIDH/src/common/fp/namespace\_asm.py}}

\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{namespace__asm_8py_source_l00001}00001\ \textcolor{keyword}{import}\ re}
...
\DoxyCodeLine{\Hypertarget{namespace__asm_8py_source_l00004}00004\ FNAME\_REGEX\ =\ re.compile(\textcolor{stringliteral}{r"{}"{}"{}}}
...
\DoxyCodeLine{\Hypertarget{namespace__asm_8py_source_l00010}00010\ \textcolor{keyword}{def\ }get\_functionnames(filecontent:\ str)\ -\/>\ Set[str]:}
...
\DoxyCodeLine{\Hypertarget{namespace__asm_8py_source_l00024}00024\ \ \ \ \ \ \ \ \ print(f\textcolor{stringliteral}{"{}Usage:\ \{sys.argv[0]\}\ prime\ file.s"{}},\ file=sys.stderr)}
\DoxyCodeLine{\Hypertarget{namespace__asm_8py_source_l00025}00025\ \ \ \ \ \ \ \ \ exit(1)}
\DoxyCodeLine{\Hypertarget{namespace__asm_8py_source_l00026}00026\ \ \ \ \ prime\ =\ sys.argv[1]}
\DoxyCodeLine{\Hypertarget{namespace__asm_8py_source_l00027}00027\ \ \ \ \ inputfilename\ =\ sys.argv[2]}
...
\DoxyCodeLine{\Hypertarget{namespace__asm_8py_source_l00032}00032\ \ \ \ \ \ \ \ \ contents\ =\ fh.read()}
\DoxyCodeLine{\Hypertarget{namespace__asm_8py_source_l00033}00033\ }
\DoxyCodeLine{\Hypertarget{namespace__asm_8py_source_l00034}00034\ \ \ \ \ functionnames\ =\ get\_functionnames(contents)}
...
\DoxyCodeLine{\Hypertarget{namespace__asm_8py_source_l00039}00039\ \ \ \ \ \textcolor{keyword}{assert}\ len(get\_functionnames(contents))\ ==\ 0,\ f\textcolor{stringliteral}{"{}missed\ \{get\_functionnames(contents)\}"{}}}
