...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_aa50f329ed0f505e801d8044bdc880803} 
 None \+\_\+ensure\+\_\+api\+\_\+header (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classpip_1_1__vendor_1_1requests_1_1models_1_1_response}{Response}}}]{response}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
\DoxyCodeLine{00080\ \ \ \ \ content\_type\ =\ response.headers.get(\textcolor{stringliteral}{"{}Content-\/Type"{}},\ \textcolor{stringliteral}{"{}Unknown"{}})}
\DoxyCodeLine{00081\ }
\DoxyCodeLine{00082\ \ \ \ \ content\_type\_l\ =\ content\_type.lower()}
\DoxyCodeLine{00083\ \ \ \ \ \textcolor{keywordflow}{if}\ content\_type\_l.startswith(}
\DoxyCodeLine{00084\ \ \ \ \ \ \ \ \ (}
...
\DoxyCodeLine{00091\ }
\DoxyCodeLine{00092\ \ \ \ \ \textcolor{keywordflow}{raise}\ \_NotAPIContent(content\_type,\ response.request.method)}
\DoxyCodeLine{00093\ }
\DoxyCodeLine{00094\ }
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_a6a61c507bdcf6674c736b47b6e299d5e} 
 None \+\_\+ensure\+\_\+api\+\_\+response (\begin{DoxyParamCaption}\item[{str}]{url}{, }\item[{Pip\+Session}]{session}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
\DoxyCodeLine{00107\ \ \ \ \ scheme,\ netloc,\ path,\ query,\ fragment\ =\ urllib.parse.urlsplit(url)}
...
\DoxyCodeLine{00110\ }
\DoxyCodeLine{00111\ \ \ \ \ resp\ =\ session.head(url,\ allow\_redirects=\textcolor{keyword}{True})}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_a790e7fd1960c7ff461c48b18bfb5a7d1} 
 Optional\mbox{[}str\mbox{]} \+\_\+get\+\_\+encoding\+\_\+from\+\_\+headers (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{namespacepip_1_1__internal_1_1index_1_1collector_acc8011d409502c4a78917f6308db8bdd}{Response\+Headers}}}]{headers}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
\DoxyCodeLine{00183\ \ \ \ \ \ \ \ \ m\ =\ email.message.Message()}
\DoxyCodeLine{00184\ \ \ \ \ \ \ \ \ m[\textcolor{stringliteral}{"{}content-\/type"{}}]\ =\ headers[\textcolor{stringliteral}{"{}Content-\/Type"{}}]}
\DoxyCodeLine{00185\ \ \ \ \ \ \ \ \ charset\ =\ m.get\_param(\textcolor{stringliteral}{"{}charset"{}})}
...
Referenced by \mbox{\hyperlink{collector_8py_source_l00325}{\+\_\+make\+\_\+index\+\_\+content()}}.
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_a96588bebaebadf441ec2f3d0fe6a4668} 
 Optional\mbox{[}"{}Index\+Content"{}\mbox{]} \+\_\+get\+\_\+index\+\_\+content (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classpip_1_1__internal_1_1models_1_1link_1_1_link}{Link}}}]{link}{, }\item[{\texorpdfstring{$\ast$}{*}}]{}{, }\item[{Pip\+Session}]{session}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
\DoxyCodeLine{00337\ \ \ \ \ url\ =\ link.url.split(\textcolor{stringliteral}{"{}\#"{}},\ 1)[0]}
\DoxyCodeLine{00338\ }
...
\DoxyCodeLine{00342\ \ \ \ \ \ \ \ \ logger.warning(}
...
\DoxyCodeLine{00350\ \ \ \ \ scheme,\ \_,\ path,\ \_,\ \_,\ \_\ =\ urllib.parse.urlparse(url)}
\DoxyCodeLine{00351\ \ \ \ \ \textcolor{keywordflow}{if}\ scheme\ ==\ \textcolor{stringliteral}{"{}file"{}}\ \textcolor{keywordflow}{and}\ os.path.isdir(urllib.request.url2pathname(path)):}
...
\DoxyCodeLine{00354\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ \textcolor{keywordflow}{not}\ url.endswith(\textcolor{stringliteral}{"{}/"{}}):}
...
\DoxyCodeLine{00360\ \ \ \ \ \ \ \ \ url\ =\ urllib.parse.urljoin(url,\ \textcolor{stringliteral}{"{}index.html"{}})}
\DoxyCodeLine{00361\ \ \ \ \ \ \ \ \ logger.debug(\textcolor{stringliteral}{"{}\ file:\ URL\ is\ directory,\ getting\ \%s"{}},\ url)}
\DoxyCodeLine{00362\ }
...
\DoxyCodeLine{00366\ \ \ \ \ \ \ \ \ logger.warning(}
...
\DoxyCodeLine{00372\ \ \ \ \ \ \ \ \ logger.warning(}
...
\DoxyCodeLine{00377\ \ \ \ \ \ \ \ \ \ \ \ \ exc.request\_desc,}
\DoxyCodeLine{00378\ \ \ \ \ \ \ \ \ \ \ \ \ exc.content\_type,}
\DoxyCodeLine{00379\ \ \ \ \ \ \ \ \ )}
...
\DoxyCodeLine{00387\ \ \ \ \ \ \ \ \ \_handle\_get\_simple\_fail(link,\ reason,\ meth=logger.info)}
\DoxyCodeLine{00388\ \ \ \ \ \textcolor{keywordflow}{except}\ requests.ConnectionError\ \textcolor{keyword}{as}\ exc:}
\DoxyCodeLine{00389\ \ \ \ \ \ \ \ \ \_handle\_get\_simple\_fail(link,\ f\textcolor{stringliteral}{"{}connection\ error:\ \{exc\}"{}})}
\DoxyCodeLine{00390\ \ \ \ \ \textcolor{keywordflow}{except}\ requests.Timeout:}
...
\DoxyCodeLine{00393\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \_make\_index\_content(resp,\ cache\_link\_parsing=link.cache\_link\_parsing)}
...
References \mbox{\hyperlink{collector_8py_source_l00117}{\+\_\+get\+\_\+simple\+\_\+response()}}, \mbox{\hyperlink{collector_8py_source_l00317}{\+\_\+handle\+\_\+get\+\_\+simple\+\_\+fail()}}, \mbox{\hyperlink{collector_8py_source_l00325}{\+\_\+make\+\_\+index\+\_\+content()}}, and \mbox{\hyperlink{collector_8py_source_l00055}{\+\_\+match\+\_\+vcs\+\_\+scheme()}}.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{dc/def/namespacepip_1_1__internal_1_1index_1_1collector_a96588bebaebadf441ec2f3d0fe6a4668_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{dc/def/namespacepip_1_1__internal_1_1index_1_1collector_a96588bebaebadf441ec2f3d0fe6a4668_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_ac8a6cf6629f016c4d184b2b146eb65b4} 
 \mbox{\hyperlink{classpip_1_1__vendor_1_1requests_1_1models_1_1_response}{Response}} \+\_\+get\+\_\+simple\+\_\+response (\begin{DoxyParamCaption}\item[{str}]{url}{, }\item[{Pip\+Session}]{session}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
\DoxyCodeLine{00132\ }
\DoxyCodeLine{00133\ \ \ \ \ logger.debug(\textcolor{stringliteral}{"{}Getting\ page\ \%s"{}},\ redact\_auth\_from\_url(url))}
\DoxyCodeLine{00134\ }
\DoxyCodeLine{00135\ \ \ \ \ resp\ =\ session.get(}
...
\DoxyCodeLine{00170\ }
\DoxyCodeLine{00171\ \ \ \ \ logger.debug(}
\DoxyCodeLine{00172\ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}Fetched\ page\ \%s\ as\ \%s"{}},}
\DoxyCodeLine{00173\ \ \ \ \ \ \ \ \ redact\_auth\_from\_url(url),}
\DoxyCodeLine{00174\ \ \ \ \ \ \ \ \ resp.headers.get(\textcolor{stringliteral}{"{}Content-\/Type"{}},\ \textcolor{stringliteral}{"{}Unknown"{}}),}
\DoxyCodeLine{00175\ \ \ \ \ )}
\DoxyCodeLine{00176\ }
...
Referenced by \mbox{\hyperlink{collector_8py_source_l00336}{\+\_\+get\+\_\+index\+\_\+content()}}.
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_a08debcfc9ae93f980ca5620d72b08e37} 
 None \+\_\+handle\+\_\+get\+\_\+simple\+\_\+fail (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classpip_1_1__internal_1_1models_1_1link_1_1_link}{Link}}}]{link}{, }\item[{Union\mbox{[}str, Exception\mbox{]}}]{reason}{, }\item[{Optional\mbox{[}Callable\mbox{[}..., None\mbox{]}\mbox{]} }]{meth}{ = {\ttfamily None}}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
\DoxyCodeLine{00319\ \ \ \ \ \ \ \ \ meth\ =\ logger.debug}
\DoxyCodeLine{00320\ \ \ \ \ meth(\textcolor{stringliteral}{"{}Could\ not\ fetch\ URL\ \%s:\ \%s\ -\/\ skipping"{}},\ link,\ reason)}
\DoxyCodeLine{00321\ }
\DoxyCodeLine{00322\ }
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_a86f5174b80e603975de77b610eeaa710} 
 \mbox{\hyperlink{classpip_1_1__internal_1_1index_1_1collector_1_1_index_content}{Index\+Content}} \+\_\+make\+\_\+index\+\_\+content (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classpip_1_1__vendor_1_1requests_1_1models_1_1_response}{Response}}}]{response}{, }\item[{bool }]{cache\+\_\+link\+\_\+parsing}{ = {\ttfamily True}}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
\DoxyCodeLine{00326\ \ \ \ \ encoding\ =\ \_get\_encoding\_from\_headers(response.headers)}
\DoxyCodeLine{00327\ \ \ \ \ \textcolor{keywordflow}{return}\ IndexContent(}
\DoxyCodeLine{00328\ \ \ \ \ \ \ \ \ response.content,}
\DoxyCodeLine{00329\ \ \ \ \ \ \ \ \ response.headers[\textcolor{stringliteral}{"{}Content-\/Type"{}}],}
\DoxyCodeLine{00330\ \ \ \ \ \ \ \ \ encoding=encoding,}
\DoxyCodeLine{00331\ \ \ \ \ \ \ \ \ url=response.url,}
...
References \mbox{\hyperlink{collector_8py_source_l00180}{\+\_\+get\+\_\+encoding\+\_\+from\+\_\+headers()}}.
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_aabde926725ae445f4be1a6f54d4db1fc} 
 Optional\mbox{[}str\mbox{]} \+\_\+match\+\_\+vcs\+\_\+scheme (\begin{DoxyParamCaption}\item[{str}]{url}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
\DoxyCodeLine{00060\ \ \ \ \ \textcolor{keywordflow}{for}\ scheme\ \textcolor{keywordflow}{in}\ vcs.schemes:}
\DoxyCodeLine{00061\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ url.lower().startswith(scheme)\ \textcolor{keywordflow}{and}\ url[len(scheme)]\ \textcolor{keywordflow}{in}\ \textcolor{stringliteral}{"{}+:"{}}:}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_a56d5215ace05d08c82d3ceeb2697280c} 
 Iterable\mbox{[}\mbox{\hyperlink{classpip_1_1__internal_1_1models_1_1link_1_1_link}{Link}}\mbox{]} parse\+\_\+links (\begin{DoxyParamCaption}\item[{"{}Index\+Content"{}}]{page}{}\end{DoxyParamCaption})}
...
\DoxyCodeLine{00233\ }
\DoxyCodeLine{00234\ \ \ \ \ content\_type\_l\ =\ page.content\_type.lower()}
\DoxyCodeLine{00235\ \ \ \ \ \textcolor{keywordflow}{if}\ content\_type\_l.startswith(\textcolor{stringliteral}{"{}application/vnd.pypi.simple.v1+json"{}}):}
\DoxyCodeLine{00236\ \ \ \ \ \ \ \ \ data\ =\ json.loads(page.content)}
\DoxyCodeLine{00237\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ file\ \textcolor{keywordflow}{in}\ data.get(\textcolor{stringliteral}{"{}files"{}},\ []):}
\DoxyCodeLine{00238\ \ \ \ \ \ \ \ \ \ \ \ \ link\ =\ Link.from\_json(file,\ page.url)}
...
\DoxyCodeLine{00243\ }
\DoxyCodeLine{00244\ \ \ \ \ parser\ =\ HTMLLinkParser(page.url)}
\DoxyCodeLine{00245\ \ \ \ \ encoding\ =\ page.encoding\ \textcolor{keywordflow}{or}\ \textcolor{stringliteral}{"{}utf-\/8"{}}}
\DoxyCodeLine{00246\ \ \ \ \ parser.feed(page.content.decode(encoding))}
\DoxyCodeLine{00247\ }
\DoxyCodeLine{00248\ \ \ \ \ url\ =\ page.url}
\DoxyCodeLine{00249\ \ \ \ \ base\_url\ =\ parser.base\_url\ \textcolor{keywordflow}{or}\ url}
\DoxyCodeLine{00250\ \ \ \ \ \textcolor{keywordflow}{for}\ anchor\ \textcolor{keywordflow}{in}\ parser.anchors:}
\DoxyCodeLine{00251\ \ \ \ \ \ \ \ \ link\ =\ Link.from\_element(anchor,\ page\_url=url,\ base\_url=base\_url)}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_acc51c183456bf01f6547d990d383db94} 
 \mbox{\hyperlink{classpip_1_1__internal_1_1index_1_1collector_1_1_parse_links}{Parse\+Links}} with\+\_\+cached\+\_\+index\+\_\+content (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classpip_1_1__internal_1_1index_1_1collector_1_1_parse_links}{Parse\+Links}}}]{fn}{}\end{DoxyParamCaption})}
...
\DoxyCodeLine{00217\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ list(fn(cacheable\_page.page))}
\DoxyCodeLine{00218\ }
\DoxyCodeLine{00219\ \ \ \ \ \textcolor{preprocessor}{@functools.wraps(fn)}}
\DoxyCodeLine{00220\ \ \ \ \ \textcolor{keyword}{def\ }wrapper\_wrapper(page:\ \textcolor{stringliteral}{"{}IndexContent"{}})\ -\/>\ List[Link]:}
\DoxyCodeLine{00221\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ page.cache\_link\_parsing:}
...
\Hypertarget{namespacepip_1_1__internal_1_1index_1_1collector_a0b14e488ae28d98d262453f3e9cd6e4d}\index{pip.\_internal.index.collector@{pip.\_internal.index.collector}!logger@{logger}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_a0b14e488ae28d98d262453f3e9cd6e4d} 
...
\Hypertarget{namespacepip_1_1__internal_1_1index_1_1collector_aac39b55be6469395f55ff0292ad8184c}\index{pip.\_internal.index.collector@{pip.\_internal.index.collector}!Protocol@{Protocol}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_aac39b55be6469395f55ff0292ad8184c} 
Protocol = object}
...
\Hypertarget{namespacepip_1_1__internal_1_1index_1_1collector_acc8011d409502c4a78917f6308db8bdd}\index{pip.\_internal.index.collector@{pip.\_internal.index.collector}!ResponseHeaders@{ResponseHeaders}}
...
{\footnotesize\ttfamily \label{namespacepip_1_1__internal_1_1index_1_1collector_acc8011d409502c4a78917f6308db8bdd} 
Response\+Headers = Mutable\+Mapping\mbox{[}str, str\mbox{]}}
